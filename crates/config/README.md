...
The `config` crate manages application-wide configuration loading for Premire. It handles reading setting files, resolving environment variables (`.env`), discovering platform directories, and mapping configuration models into runtime structures such as `AgentConfig`.
