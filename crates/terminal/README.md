...
The `terminal` crate manages interactive shell sessions and terminal processes for Premire. It handles shell executable discovery, asynchronous input/output stream management, session tracking, process cleanup, and IPC events between the application backend and frontend terminal components.
