...
The `chats` crate handles persistent storage, retrieval, and schema migrations for conversation sessions within the Premire ecosystem. Built on top of SQLite (`rusqlite`), it manages user-agent chat histories, session metadata, and message serialization.
