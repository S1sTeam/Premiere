# Premire developer documentation

This directory is the source of truth for Premire product and engineering conventions. It describes both how the code is organized and the criteria by which a change is considered ready.
