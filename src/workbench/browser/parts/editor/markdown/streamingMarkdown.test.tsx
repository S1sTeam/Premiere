...
describe("Markdown layout", () => {
  ...
  it("sanitizes dangerous link protocols (javascript:) and raw HTML tags", () => {
    const malicious = '[click me](javascript:alert("xss")) <img src=x onerror=alert(1)>';
    const { container } = render(<Markdown content={malicious} isAssistant />);
