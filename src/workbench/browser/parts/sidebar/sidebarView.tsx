    ...
    <>
      ...
      >
        <div className="app-sidebar__inner" style={{ width: `${localWidth}px` }}>
          ...
          <div className="app-sidebar__brand-banner">
            <div className="app-sidebar__brand-badge">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                <rect x="3" y="3" width="7" height="18" rx="3.5" fill="#f1f5f9" />
                <rect x="14" y="3" width="7" height="10" rx="3.5" fill="#94a3b8" />
              </svg>
              <span className="app-sidebar__brand-name">Premire</span>
            </div>
          </div>
