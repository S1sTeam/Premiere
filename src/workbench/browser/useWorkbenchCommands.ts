...
export function useAppCommands(layout: WorkspaceLayout, actions: AppCommandActions) {
  ...
  const handleCommand = useCallback(
    (id: string) => {
      switch (id) {
        ...
        case "open-mcp":
          ...
          break;
        case "open-hotkeys":
          actions.openSettings("keybindings");
          break;
        case "open-providers":
    ...
    [actions, setTerminalOpen, setFileTreeOpen, setGitPanelOpen, handleToggleChatSide, handleCloseActiveFile, handleToggleSearchInCode],
  );
  ...
  const { shortcuts, updateBinding, resetBinding } = useShortcuts({
    ...
    saveFile: () => dispatchWindowCommand("vibe:save-file"),
    saveAllFiles: () => dispatchWindowCommand("vibe:save-all-files"),
    formatDocument: () => dispatchWindowCommand("vibe:format-document"),
    toggleComment: () => dispatchWindowCommand("vibe:toggle-line-comment"),
    toggleWordWrap: () => dispatchWindowCommand("vibe:toggle-word-wrap"),
    findInFile: () => dispatchWindowCommand("vibe:find-in-file"),
    replaceInFile: () => dispatchWindowCommand("vibe:replace-in-file"),
    duplicateLine: () => dispatchWindowCommand("vibe:duplicate-line"),
    moveLineUp: () => dispatchWindowCommand("vibe:move-line-up"),
    moveLineDown: () => dispatchWindowCommand("vibe:move-line-down"),
    reopenClosedTab: () => dispatchWindowCommand("vibe:reopen-closed-tab"),
    toggleGitPanel: () => setGitPanelOpen((o) => !o),
    zoomIn: () => dispatchWindowCommand("vibe:zoom-in"),
    zoomOut: () => dispatchWindowCommand("vibe:zoom-out"),
    zoomReset: () => dispatchWindowCommand("vibe:zoom-reset"),
    openHotkeys: () => actions.openSettings("hotkeys"),
    openProviders: () => actions.openSettings("providers"),
    openMcp: () => actions.openSettings("mcp"),
  });
