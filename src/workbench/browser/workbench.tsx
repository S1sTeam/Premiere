...
import { StatusBar } from "@/workbench/browser/parts/statusBar/statusBar";
...
import { useComposerDockAnimation } from "./useComposerDockAnimation";

const RIGHT_PANEL_WIDTH_KEY = "premire:right-panel-width:v1";
...
export function Workbench({
  ...
  const composerDockRef = useComposerDockAnimation(items.length === 0);
          ...
          >
            ...
            {drillDownId ? (
              ...
              <>
                ...
                <div className={`layout__chat-hero${items.length === 0 ? "" : " layout__chat-hero--hidden"}`}>
                  <EmptyWorkspaceView
                ...
                <div
                  ref={composerDockRef}
                  className={`layout__composer-dock${items.length === 0 ? " layout__composer-dock--hero" : " layout__composer-dock--docked"}`}
                >
                  <Composer
                    disabled={busy}
                    workspace={cwd}
                    ...
                    initialTextRevision={rollbackRevision + starterDraft.revision}
