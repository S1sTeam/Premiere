...
const CACHE_DB = "premire-modelsdev";
const CACHE_STORE = "catalog";
const CACHE_RECORD = "canonical";
const LEGACY_CACHE_KEY = "premire_modelsdev_catalog";
const LEGACY_LAST_SYNC_KEY = "premire_modelsdev_last_sync";
...
export const STANDARD_BASE_URLS: Record<string, string> = {
  premire: "https://free.sysik.mom/v1",
  ...
  public getProvider(id: string): ModelsDevProvider | undefined {
    if (id === "premire") {
      return {
        id: "premire",
        name: "Premire AI",
        api: "https://free.sysik.mom/v1",
        doc: "https://t.me/sysgood",
  ...
  public getProviders(): ProviderTemplate[] {
    ...
    for (const popId of POPULAR_PROVIDER_ORDER) {
      ...
      templatesMap.set(canonicalId, {
        ...
        baseUrl,
        modelsUrl: canonicalId === "premire" ? "https://free.sysik.mom/v1/models" : undefined,
        docUrl: p?.doc,
        env: p?.env,
      });
    }
