...
function applyThemeVarsAnimated(vars: ThemeVars, scheme?: ResolvedScheme): void {
...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    root.classList.toggle("theme-light", resolvedScheme === "light");
    root.classList.toggle("theme-dark", resolvedScheme === "dark");
  }, [activeVars, resolvedScheme]);
  ...
  const setTheme = useCallback(
    (id: string, scheme?: ResolvedScheme) => {
      ...
      if (!scheme || scheme === resolvedScheme) {
        ...
        applyThemeVarsAnimated({ ...nextVars, ...overrides[nextTheme.id]?.[resolvedScheme] }, resolvedScheme);
      }
  ...
  const setColorScheme = useCallback(
    (scheme: ColorScheme) => {
      ...
      applyThemeVarsAnimated({ ...nextBase, ...overrides[nextTheme.id]?.[nextResolved] }, nextResolved);
      setColorSchemeState(scheme);
      setPreviewId(null);
